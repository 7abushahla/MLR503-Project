...
Due to the nature of this task, we have to other metrics to evaluate the performance of the model. These are character error rate (CER) and word error rate (WER). We use the Levenshtein distsance.
